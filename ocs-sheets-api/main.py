...
app = FastAPI(title="OCS Sheets API")

# Health check endpoint
@app.get("/health")
def health_check():
    """Health check endpoint for service monitoring"""
    return {"status": "healthy", "service": "sheets-api"}

# Pydantic models for Time Sheets
...
# Pydantic models for Fuel Sheets
