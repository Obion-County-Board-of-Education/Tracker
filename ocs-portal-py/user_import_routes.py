    ...
    try:
        ...
        for user in users:
            user_data = {
                ...
                "department": user.department,  # Direct department field from User table
                "office_location": user.office_location,  # Office location field from User table
...
async def delete_user(
    ...
    try:
        ...
        if user.azure_user_id == current_user.get('user_id'):
